...
class NotificationPacket: MedtrumBasePacket, MedtrumBasePacketProtocol {
    ...
    private func emptyResponse(state: PatchState) -> SynchronizePacketResponse {
    ...
    private let maskByteSizes: [UInt16: Int] = [
        ...
        MASK_ALARM: 4,
        MASK_AGE: 4,
        MASK_MAGNETO_PLACE: 2,
        MASK_UNUSED_CGM: 5,
        MASK_UNUSED_COMMAND_CONFIRM: 2,
        MASK_UNUSED_AUTO_STATUS: 2,
        MASK_UNUSED_LEGACY: 2
    ]
